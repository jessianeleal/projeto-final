...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse justify-content-end" id="navbarNavDropdown">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="./doar.php" id="doar">Doar</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="./estoque.php" id="estoque">Estoque <span class="sr-only">(current)</span></a>
                    </li>
                    <li class="nav-item">
    ...
    <header class="header-estoque">
        <h1>Como podemos te ajudar a <br>fazer uma criança sorrir?</h1>
    </header>
    <main class="container my-5">
        <h2 class="title-sos">Estoque disponível</h2>
        <section class="categorias mt-4">
            <div class="accordion" id="accordionExample">
                <div class="card">
                    <div class="card-header  btn-estoque" id="headingOne">
                        <h5 class="mb-0">
                    ...
                    <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordionExample">
                        <div class="card-body">
                            ...
                            <?php
                                    ...
                                    $sql = "SELECT * FROM itenssos WHERE categoria='roupa'"; //Roupa
                                    ...
                                    if ($result->num_rows > 0) {
                                        ...
                                        while($row = $result->fetch_assoc()) {
                                            echo "<li class='my-4'>Localização: ".$row["localizacao"]." > Tipo: ".$row["tipo"]." > Cor: ".$row["cor"]." > Tamanho: ".$row["tamanho"]." <button type='button' class='btn btn-danger' data-toggle='modal' data-target='#exampleModal'>Solicitar</button></li>";
                                        }
                                    } else {
                                        echo "Sem itens no estoque";
                                    }
                                    $conn->close();
                                ?>
                ...
                <div class="card">
                    <div class="card-header btn-estoque" id="headingTwo">
                        <h5 class="mb-0">
                        ...
                        <div class="card-body">
                            <ol>
                                <?php
                                    ...
                                    $sql = "SELECT * FROM itenssos WHERE categoria='alimento'"; //Alimento
                                    ...
                                    if ($result->num_rows > 0) {
                                        // output data of each row
                                        while($row = $result->fetch_assoc()) {
                                            echo "<li class='my-4'>Localização: ".$row["localizacao"]." > Tipo: ".$row["tipo"]." > Validade: ".$row["validade"]." > Quantidade: ".$row["quantidade"]." <button type='button' class='btn btn-danger' data-toggle='modal' data-target='#exampleModal'>Solicitar</button></li>";
                                        }
                                    } else {
                                        echo "Sem itens no estoque";
                                    }
                ...
                <div class="card">
                    <div class="card-header btn-estoque" id="headingThree">
                        <h5 class="mb-0">
                    ...
                    <div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#accordionExample">
                        <div class="card-body">
                            ...
                            <?php
                                    ...
                                    $sql = "SELECT * FROM itenssos WHERE categoria='brinquedo'"; //Brinquedo
                ...
                <div class="card">
                    <div class="card-header btn-estoque" id="headingFour">
                        <h5 class="mb-0">
                        ...
                        <div class="card-body">
                            <ol>
                                <?php
                                    ...
                                    $sql = "SELECT * FROM itenssos WHERE categoria='outro'"; //Roupa
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <strong>Você realmente necessita deste item?</strong>
                        </div>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancelar</button>
                            <button type="button" class="btn btn-danger" data-dismiss="modal" data-toggle="modal"
                                data-target=".bd-example-modal-sm">Solicitar</button>
                        </div>
                    </div>
                </div>
            </div>
